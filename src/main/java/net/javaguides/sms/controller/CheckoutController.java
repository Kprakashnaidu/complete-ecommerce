...
public class CheckoutController {
	...
	public String saveCheckout(@ModelAttribute("checkout") Checkout checkout,  BindingResult bindingResult) {
		...
		//model.addAttribute("checkout", checkoutService.getCheckoutById(orderId));
		
	return "redirect:/orderDetails";
	}
	
	
	  @GetMapping("/orderDetails") public String viewOrderDetails(Model model) {
	  model.addAttribute("checkout", checkoutService.getLargestOrderId()); 
	  return "orderDetails";
	  }
	...
	@GetMapping("/adminOrderDetails/{id}")
	public String viewOrderDetails(@PathVariable Long id, Model model) {
		
		model.addAttribute("user",userService.getByOrderId(id));
    // System.out.println(userService.getByOrderId(id));
	model.addAttribute("checkout", checkoutService.getCheckoutById(id));
